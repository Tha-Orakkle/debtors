    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.UUID('06b574dd-2bf7-4633-b9b0-27cc7899649e'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prev_amount', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=11)),
                ('new_amount', models.DecimalField(decimal_places=2, max_digits=11, null=True)),
                ('amount_paid', models.DecimalField(decimal_places=2, max_digits=11, null=True)),
                ('mode_of_payment', models.CharField(choices=[('cash', 'cash'), ('bank_transaction', 'bank_transaction')], max_length=20)),
